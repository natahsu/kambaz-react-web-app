...
tag to tell browsers to render the gaps.
    ...
    My favorite recipe, How to make curry:
    <ol id="wd-your-favorite-recipe">
        <li>Cut up desired vegetables</li>
        <li>Lightly sear vegetables</li>
        <li>Boil water and add curry cubes</li>
        <li>Add vegetables and meat to boiling curry</li>
        <li>Serve to eat with rice!</li>
    </ol>
