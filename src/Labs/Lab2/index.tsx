            ...
            <div id="wd-css-class-selectors">
              ...
              <div className="wd-selector-1">
                ...
                <div className="wd-selector-2">
                  ...
                  <div id="wd-css-foregroundcolor">
                    <ForegroundColors />
                  </div>

                  <div id="wd-css-backgroundcolor">
                    <BackgroundColors />
                  </div>
                  ...
                  <div id="wd-css-reacticons">
                    <ReactIconsSampler />
                  </div>

                  <div id="wd-css-bootstrapgrids">
                    <BootstrapGrids />
                  </div>

                  <div id="wd-css-screensizelabel">
                    <ScreenSizeLabel />
                  </div>

                  <div id="wd-css-bootstraptables">
                    <BootstrapTables />
                  </div>

                  <div id="wd-css-bootstraplists">
                    <BootstrapLists />
                  </div>

                  <div id="wd-css-bootstrapforms">
                    <BootstrapForms />
                  </div>
